...
const forum = [
  ...
  },
  {
    user: "Alice",
    img: "/social/f1.png",
    text: "Lawn Mower Blade Wont Engage (Here How to Fix This) There is nothing more frustrating than heading out on a Sunday morning to mow your lawn only to find out that your lawn mower blades wont engage. No matter how many times you pull the lever or flip the switch, your John Deere, Cub Cadet, or whatever brand you have refuses to engage its blades. Well, depending on your mowers design, there could be several reasons why your mower deck wont engage. So lets dig into these reasons and figure out what is messing with your Sunday morning.",
  },

  {
    user: "Michale",
    img: "/social/f2.png",
    text: "To stand up on your paddle board, start from a kneeling position on your board and then:Move one foot at a time: Put your hands on the sides of the board to stabilize it and move one foot at a time to place your feet where your knees are. Weight your hands: When moving from kneeling to standing, put the majority of your weight onto your hands so you'll feel more stable as you move your feet.Raise your chest and stand: With your feet on the board, rather than standing up in one motion, start by raising your chest up while keeping your knees bent. Once your chest is vertical, extend your legs to stand up.Practice on land: It can be helpful to practice standing up on land to get used to the movements without the instability of water. To do so, take the fin off your board and lay the board down on a soft surface, such as grass or sand. Lie down or kneel on the board and go through the motion of standing up",
  },
];
