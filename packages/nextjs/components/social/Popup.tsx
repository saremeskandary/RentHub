...
const Popup: FC<{
  ...
  return (
    <div
      className={`fixed inset-0 z-[999] flex items-center justify-center bg-black bg-opacity-50 transition-opacity ${isOpen ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"}`}
    >
      <div className="relative w-full max-w-[500px] rounded-lg bg-white p-6">
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-5">
          ...
          <button
            type="submit"
            className="rounded-md bg-gray-400 px-4 py-2 text-white transition-colors hover:bg-gray-300"
          >
            Submit
          </button>
        </form>
