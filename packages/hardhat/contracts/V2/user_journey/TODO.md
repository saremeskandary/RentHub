create struct for user mapping address {validataion time, isValidataion true of false, reputation score, first time that user joined} and rentee product {name, how many time rented}
